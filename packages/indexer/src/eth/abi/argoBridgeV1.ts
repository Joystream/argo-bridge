...
export const events = {
    ArgoBridgeFeeChanged: event("0x9d699f862acc3d76830ba2f9d1efc23c25190e4309f64c091cffc65230fe568f", "ArgoBridgeFeeChanged(uint256)", {"newFee": p.uint256}),
    ArgoBridgeFeesWithdrawn: event("0x120c23ad9d3d7272a0d20dd6b7a2822584daf524e67963daa6a7d47b7576a816", "ArgoBridgeFeesWithdrawn(address,uint256)", {"destination": p.address, "amount": p.uint256}),
    ArgoBridgeMintingLimitsUpdated: event("0xc01acf06a73b9c6b1e27941f05c5a9e8f8132593e96d257da8869304c6236f69", "ArgoBridgeMintingLimitsUpdated(uint256,uint256)", {"newMintingLimitPeriodLengthBlocks": p.uint256, "newMintingLimitPerPeriod": p.uint256}),
    ArgoBridgeStatusChanged: event("0x674a79b744f31247a99ff1ed4a383c0c77299efbdb099b5f69a75077aa3872ae", "ArgoBridgeStatusChanged(uint8)", {"newStatus": p.uint8}),
    ArgoTransferToEthCompleted: event("0x7e23ecf974046609d9a1de48d379cfca42f21df5a2a1a061dc97468705e44ec2", "ArgoTransferToEthCompleted(uint256,address,uint256)", {"joyTransferId": indexed(p.uint256), "ethDestAddress": indexed(p.address), "amount": p.uint256}),
    ArgoTransferToJoystreamRequested: event("0x82faa25a69607faadf0963495313e5c2b60799b5c3a65e35d850b77e73b79f6d", "ArgoTransferToJoystreamRequested(uint256,address,bytes32,uint256)", {"ethTransferId": indexed(p.uint256), "ethRequester": indexed(p.address), "joyDestAccount": p.bytes32, "amount": p.uint256}),
    ArgoTransferToJoystreamReverted: event("0xa25b21b9fa597e02e957bf452497316423b937661dfa0b53f2c89d5e43725d43", "ArgoTransferToJoystreamReverted(uint256,address,uint256,string)", {"ethTransferId": indexed(p.uint256), "revertAddress": indexed(p.address), "revertAmount": p.uint256, "rationale": p.string}),
...
export const functions = {
    ...
    bridgeFee: viewFun("0x82b12dd7", "bridgeFee()", {}, p.uint256),
    bridgeStatus: viewFun("0x865f87ac", "bridgeStatus()", {}, p.uint8),
    completeTransferToEth: fun("0xc194116f", "completeTransferToEth(uint256,address,uint256)", {"joyTransferId": p.uint256, "ethDestAddress": p.address, "amount": p.uint256}, ),
    currentMintingPeriodEndBlock: viewFun("0x447117b4", "currentMintingPeriodEndBlock()", {}, p.uint256),
    currentMintingPeriodMinted: viewFun("0x120da508", "currentMintingPeriodMinted()", {}, p.uint256),
    getRoleAdmin: viewFun("0x248a9ca3", "getRoleAdmin(bytes32)", {"role": p.bytes32}, p.bytes32),
    grantRole: fun("0x2f2ff15d", "grantRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, ),
    hasRole: viewFun("0x91d14854", "hasRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, p.bool),
    joystreamErc20: viewFun("0x890ef592", "joystreamErc20()", {}, p.address),
    mintingLimitPerPeriod: viewFun("0x82ac7008", "mintingLimitPerPeriod()", {}, p.uint256),
    mintingLimitPeriodLengthBlocks: viewFun("0x5cfb2ad2", "mintingLimitPeriodLengthBlocks()", {}, p.uint256),
    pauseBridge: fun("0x7dd0480f", "pauseBridge()", {}, ),
    renounceRole: fun("0x36568abe", "renounceRole(bytes32,address)", {"role": p.bytes32, "callerConfirmation": p.address}, ),
    requestTransferToJoystream: fun("0xff926998", "requestTransferToJoystream(bytes32,uint256)", {"joyDestAccount": p.bytes32, "amount": p.uint256}, ),
    revertTransferToJoystream: fun("0x22e4ca23", "revertTransferToJoystream(uint256,address,uint256,string)", {"ethTransferId": p.uint256, "revertAddress": p.address, "revertAmount": p.uint256, "rationale": p.string}, ),
    revokeRole: fun("0xd547741f", "revokeRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, ),
    setBridgeFee: fun("0x998cdf83", "setBridgeFee(uint256)", {"newBridgeFee": p.uint256}, ),
    setMintingLimits: fun("0x84f302f1", "setMintingLimits(uint256,uint256)", {"newMintingLimitPeriodLengthBlocks": p.uint256, "newMintingLimitPerPeriod": p.uint256}, ),
    supportsInterface: viewFun("0x01ffc9a7", "supportsInterface(bytes4)", {"interfaceId": p.bytes4}, p.bool),
    unpauseBridge: fun("0xa82f143c", "unpauseBridge()", {}, ),
    withdrawBridgeFees: fun("0xb4ed7145", "withdrawBridgeFees()", {}, ),
}
