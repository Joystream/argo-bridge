...
export const functions = {
    ...
    MINTER_ROLE: viewFun("0xd5391393", {}, p.bytes32),
    ...
    eip712Domain: viewFun("0x84b0196e", {}, {"fields": p.bytes1, "name": p.string, "version": p.string, "chainId": p.uint256, "verifyingContract": p.address, "salt": p.bytes32, "extensions": p.array(p.uint256)}),
    ...
    nonces: viewFun("0x7ecebe00", {"owner": p.address}, p.uint256),
