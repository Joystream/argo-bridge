module.exports = class Data1717080233791 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "joy_bridge_thawn_started_event" ("id" character varying NOT NULL, "chain_id" integer NOT NULL, "tx_hash" text NOT NULL, "block" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "account" text NOT NULL, CONSTRAINT "PK_974e0a081368c06240277bd96e2" PRIMARY KEY ("id"))`)
