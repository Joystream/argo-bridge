...
export type GetEvmBridgeConfigQuery = { __typename?: 'Query', evmBridgeConfigs: Array<{ __typename?: 'EvmBridgeConfig', id: string, status: EvmBridgeStatus, bridgingFee: any, totalMinted: any, totalBurned: any, mintingLimits: { __typename?: 'EvmBridgeMintingLimits', periodLength: number, periodLimit: any, currentPeriodMinted: any, currentPeriodEndBlock: number } }> };
