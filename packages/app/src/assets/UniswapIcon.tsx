interface UniswapIconProps extends React.SVGProps<SVGSVGElement> {}

const UniswapIcon: React.FC<UniswapIconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 168.3 193.8" {...props}>
    <path
