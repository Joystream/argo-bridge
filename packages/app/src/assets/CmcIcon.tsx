...
interface CmcIconProps extends React.SVGProps<SVGSVGElement> {}

const CmcIcon: React.FC<CmcIconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 76.52 77.67" {...props}>
    <path
      fill="currentColor"
